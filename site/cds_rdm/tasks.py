...
@shared_task
def sync_names():
    """Run the task to sync the names from the local user db to the names vocabulary."""
    try:
        update_or_create_names_vocabularies_2()
    except Exception as e:
        db.session.rollback()
        current_app.logger.exception(e)
...
# TODO: Check if ORCID would remove the added values
...
# this guy should match id 38
example_test = {
    "id": "0000-0003-0661-9288",
    "given_name": "Arpan",
    "family_name": "Ghosal",
    "identifiers": [{"identifier": "0000-0003-0661-9288", "scheme": "orcid"}],
}


test = {
    "id": "0000-0001-7132-35501",
    "given_name": "Predrag",
    "family_name": "Milenovic",
    "identifiers": [{"identifier": "0000-0001-7132-3550", "scheme": "orcid"}],
}

test = {
    "id": "0000-0001-6600-1290",
    "name": "Valencia, German",
    "given_name": "German",
    "family_name": "Valencia",
    "identifiers": [{"identifier": "0000-0001-6600-1290", "scheme": "orcid"}],
    "affiliations": [{"name": "Monash University (AU)"}],
}
