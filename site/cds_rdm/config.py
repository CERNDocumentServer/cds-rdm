...
CDS_ENVIRONMENT_NAME = "local"
"""The environment name, used in the side banner to distinguish between
different instances.

Available options are: 'local', 'development', 'sandbox', 'production'.
...
RDM_RECORDS_IDENTIFIERS_SCHEMES = {
    "cdsrn": {"label": _("CDS Report Number"),
...
# Map INSPIRE Identifiers schemes to InvenioRDM ones
# Format: INSPIRE_SCHEME: INVENIO_RDM_SCHEME
...
APP_RDM_RECORD_LANDING_PAGE_EXTERNAL_LINKS = [
    ...
    {"id": "inspire", "render": inspire_link_render},
]
