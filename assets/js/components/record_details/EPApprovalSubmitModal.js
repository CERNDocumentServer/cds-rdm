      ...
      <Modal open={open} onClose={this.handleClose} size="small" closeIcon>
        ...
        <Modal.Content>
          ...
          <Form>
            ...
            <Form.Field>
              <Checkbox
                label={i18next.t("Is rapid approval (i.e. 2 days) requested?")}
                name="rapid_approval"
            ...
            <Form.Field>
              <Checkbox
                label={i18next.t(
                  "Has the review process of the Collaboration Editorial Board been completed?"
                )}
            ...
            {form.cb_review_completed && (
              <Form.Group inline>
                <label>
                  {i18next.t("If so, was the process standard or accelerated?")}
                </label>
                <Form.Radio
            ...
            <Form.Field>
              <Checkbox
                label={i18next.t("Is the paper signed by the whole Collaboration?")}
                name="paper_signed"
            ...
            {!form.paper_signed && (
              <Form.Input
                label={i18next.t(
                  "If not, indicate the number of people who did not sign:"
                )}
            ...
            {!form.paper_signed && (
              <Form.Field>
                <Checkbox
                  label={i18next.t(
                    "Does the non-signature reflect controversy about the paper within the Collaboration?"
                  )}
                  name="controversy"
            ...
            <Form.TextArea
              label={i18next.t("Additional communication")}
        ...
        <Modal.Actions>
          ...
          <Button
            ...
            icon="check"
            labelPosition="left"
            content={i18next.t("Request for approval")}
